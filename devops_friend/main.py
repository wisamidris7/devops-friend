...
def DockerCommonSrL_eKs2_eKs(service=None, r=None, reset2=None):
    return DockerStartSrL_eKsS_eKsPSrL_eKsS(service, reset2, r)

def DockerStartSrL_eKsPSrL_eKsS(reset2=None, r=None, service=None):
    return setup_dockerS_eKsS_eKs(reset2, r, service)

def DockerStartSrL_eKsS_eKsPS(r=None, reset2=None, service=None):
    return DockerCommonSrL_eKsPS_eKsS(r, service, reset2)
...
def DockerCommonSrL_eKsPS_eKsS_eKs(reset2, r=None, service=None):
    return DockerStartSrL_eKsS_eKs(reset2=reset2, service=service, l=r)

def DockerStartSrL_eKsPS_eKsS(reset2=None, service=None, l=None):
    return DockerCommonSrL_eKsS_eKsPS_eKs(reset2, service, l)

def DockerCommonSrL_eKsS_eKsPS_eKs(reset2, r=None, service=None):
